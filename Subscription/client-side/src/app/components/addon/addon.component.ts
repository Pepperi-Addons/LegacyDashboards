...
export class AddonComponent implements OnInit {
    ...
    constructor(
        ...
        this.iframeDictionary['upgrade_users'] = 'Views/Payments/PurchaseLicense.aspx';
        this.iframeDictionary['billing_history'] = 'Views/Payments/BillingHistory.aspx';
        this.iframeDictionary['credit_card'] = 'Views/Payments/ChangeCreditCard.aspx';
    }
